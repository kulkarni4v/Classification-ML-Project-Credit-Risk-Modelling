...
def calculate_credit_score(input_df, base_score=300, scale_length=600):
    #the minimum rating is 300 and goes upto 300+600 = 900
    x = np.dot(input_df.values, model.coef_.T) + model.intercept_
    #above formula is  weight1 × feature1 + weight2 × feature2 + ... + bias, same as Linear regression
    #Since in Classification prblm, we want probabilities and not numbers like in regression
    #we give the 'x' to sigmoid function to give the probability of the event/

    # Apply the logistic function i.e Sigmoid function to calculate the probability
